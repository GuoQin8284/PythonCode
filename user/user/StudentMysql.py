...
class StuMysql:
    ...
    def SelectAllUser(self,tbName):
        ...
        logging.debug(self.selectAllUser)
    ...
    def Create_db(self,dbName,tbName):
        ...
        logging.debug(self.create_db)
        logging.debug(self.create_table)
        logging.debug(self.use_db)
    ...
    def DeleteUser(self,tbName,name):
        ...
        logging.info(self.deleteUser)
        return self.deleteUser

    def Find_stu(self,tbName,name):
        logging.debug(len(self.SelectUser(tbName,name)))
