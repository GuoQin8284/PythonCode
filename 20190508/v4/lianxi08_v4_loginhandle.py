...
from day6.v4.login_page import LoginHandle
...
class TestLogin(unittest.TestCase):
    ...
    def test01_login_username_not_exist(self):
        # 业务操作 -- 元素操作
        # 输入 用户名 密码  验证码
        self.login_handle.input_username("13112345678")
        self.login_handle.input_pwd("123123456")
        self.login_handle.input_verify_code("8888")
    ...
    def test02_login_password_error(self):
        # 业务操作 -- 元素操作
        # 输入 用户名 密码  验证码
        self.login_handle.input_username("13012345678")
        self.login_handle.input_pwd("123123456")
        self.login_handle.input_verify_code("8888")
